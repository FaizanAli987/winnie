...
function JoinSection() {
  return (
    <section className="mobilesm:min-h-[600px] min-h-[400px] tablet:min-h-[970px] max-w-[1810px] joinbg relative mx-auto mt-[40px] mobilesm:mt-[40px]  tablet:rounded-[60px] rounded-[30px]">
      <a
